# fix-deployment-v2.ps1 - Script para corregir problemas de despliegue
...
# Buscar y reemplazar la configuración de redis
$oldRedis = "  redis:`n    image: redis:alpine`n    restart: always`n    container_name: peruana-redis"
$newRedis = "  redis:`n    image: redis:alpine`n    restart: always`n    container_name: peruana-redis`n    volumes:`n      - redis_data:/data"

$content = $content -replace [regex]::Escape($oldRedis), $newRedis
